...
public class DecodingOfText extends AsyncTask<ImageSteganography, Void, ImageSteganography> {
    private final static String TAG = DecodingOfText.class.getName();
    private final ImageSteganography result;
    private final DecodingOfTextCallback textDecodingCallback;
    private ProgressDialog progressDialog;

    public DecodingOfText(Activity activity, DecodingOfTextCallback textDecodingCallback) {
        super();
